...
const FirstAssessmentPage = () => {
  ...
  const options = [
    { id: 1, text: "I want to improve my mental well-being", icon: "favorite" },
    { id: 2, text: "I want to try AI-guided Therapy", icon: "smart-toy" },
    { id: 3, text: "I want to heal from past trauma", icon: "flag" },
    { id: 4, text: "I want to be a better person", icon: "emoji-emotions" },
    { id: 5, text: "Just trying out the app, mate!", icon: "menu-book" },
  ];
  ...
  const handleContinue = () => {
    navigation.navigate("SecondAssessmentPage");
  };
